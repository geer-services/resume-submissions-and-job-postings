					...
					<td align="right">
						...
						<form method="post" name="showfor" id="showfor">
							<p><?php _e('Show All For:'); ?> <select name="showAllFor">
									...
									wp_reset_postdata();
									?>
									<option value="General Purpose" <?php if($showing == 'General Purpose'){
										echo 'selected="selected"';
									} ?>><?php _e('General Purpose'); ?></option>
								</select>
					...
					<tr>
						<td>
							...
							<table cellpadding="2" cellspacing="2">
								<tr>
									<td><a href="<?php echo resume_get_plugin_dir('go'); ?>/base-files/submission-entries.csv"><img src="<?php echo resume_get_plugin_dir('go'); ?>/images/icons/csv-icon.gif" border="0" alt="<?php _e('Download as CSV'); ?>"
									                                                                                                title="<?php _e('Download as CSV'); ?>"/></a></td>
								</tr>
							</table>
						</td>
					</tr>
	...
	} else
	{
		...
		<div id="rsjpLeftCol">
			<table width="100%" cellpadding="0" cellspacing="0">
				<tr>
					<td>
						<form name="back" method="post" id="backButton" enctype="multipart/form-data" action="<?php echo admin_url(); ?>admin.php?page=rsjp-submissions">
			...
			<form name='form' id='form' class='form' method='POST'>
				<table width="100%" cellpadding="0" cellspacing="0">
					...
					<tr>
						...
						<td><input type='text' name='state' size='40' value='<?php echo $single->state; ?>'/></td>
					</tr>
					<?php
			...
			<table class="widefat rsjp-download">
				...
				<tr>
					<td>
						...
						<table cellpadding="2" cellspacing="2">
							<tr>
								<td><a href="javascript:window.print()"><img src="<?php echo resume_get_plugin_dir('go'); ?>/images/icons/printing-icon-32.png" alt="<?php _e('Print Resume'); ?>" title="<?php _e('Print Resume'); ?>" id="printResume"/></a></td>
								<td><a style="visibility:hidden;" href="<?php echo WP_CONTENT_URL . '/uploads/rsjp/pdfs/' . $pdfLink; ?>" target="_blank"><img src="<?php echo resume_get_plugin_dir('go'); ?>/images/icons/pdf-icon.png" alt="<?php _e('Download to PDF'); ?>"
								                                                                                                                               title="<?php _e('Download to PDF'); ?>"/></a></td>
							</tr>
						</table>
					</td>
				</tr>
						...
						<td>
							<table cellpadding="2" cellspacing="2">
								...
								<tr>
									...
									<td><input style="visibility:hidden;" type="hidden" name="sePDF" value="<?php echo $pdfLink; ?>"/></td>
								</tr>
							</table>
							<table cellpadding="2" cellspacing="2">
								<tr>
									<td style="visibility:hidden;"><?php wp_editor('Hello, <br />The above attachment is the resume for ' . $single->fname . ' ' . $single->lname . '. <br /><br />If you cannot see this attachment, please <a href="' . WP_CONTENT_URL . '/uploads/rsjp/pdfs/' .
									                                               $pdfLink . '" target="_blank">Click Here</a>.',
